...
// Background check on launch — quiet about failures, prompts to restart when a
  ...
  u.on("update-downloaded", (info) => {
    dialog
      .showMessageBox({
        ...
        detail: "Restart Certification Launchpad to apply the update."
      })
      .then((r) => {
  ...
  try {
    ...
    if (latest && latest !== app.getVersion()) {
      ...
      dialog.showMessageBox(win, {
        ...
        message: "Certification Launchpad " + app.getVersion() + " is the latest version."
      });
    }
  } catch (e) {
    dialog.showMessageBox(win, {
